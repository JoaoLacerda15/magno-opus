...
export default function Notificacao({ navigation }) {
  const menuItems = [
    { id: 1, icon: "moon-outline", iconSet: "Ionicons", label: "Notificação", route: "aparencia" },
    { id: 2, icon: "notifications-outline", iconSet: "Ionicons", label: "Tipo de notificação", route: "notification" },
    { id: 3, icon: "language", iconSet: "Ionicons", label: "Silenciar notificação", route: "Idioma" },
  ]
